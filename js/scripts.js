...
//    $('.player').YTPlayer();
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            end: new Date('Jun 30 , 2022 11:59'),

            // Event Address
            address: 'Ebla Hotel',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Misrabi Family."
        }
    });
...
//        } else {
            $.post('https://script.google.com/macros/s/AKfycbwcffRES8bxmXAWxhIyzIXqPYzdTeqVLhBPXjs-yiDWz84AI_2NHA1fzIqJi60b-pt_kg/exec', data)
              .done(function (data) {
                // console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 33.514423, lng: 36.284593};
